...
public class Calculate {
    ...
    public static String doCalculate(String expression){
        String result = null;
        List<String> tokens;
        try{
            //词法分析
            ...
            result = String.valueOf(calcRpn(tokens));
     ...
     * @param optr
     * @param optrStack
     * @param rpnList<String>
     * @throws Exception
     */
    public static void outputOptr(String optr, Stack<String> optrStack, List<String>  rpnList)
            throws Exception{
        String preOptr;
